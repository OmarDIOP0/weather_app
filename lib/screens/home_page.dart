            ...
            children: [
              ...
              SizedBox(
                ...
                child:Column(
                  ...
                  children: [
                    const Text('Dakar',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w300),
                    ),
                    ...
                    const Center(
                      child: Text('21°C',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600,fontSize: 50),
                      ),
                    ),
                const Center(
                  child: Text('THUNDERSTORM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600,fontSize: 25),
                  )
                ),
                    const Center(
                        child: Text('Friday - 09,41am',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w300,fontSize: 26),
                        )
                    ),
